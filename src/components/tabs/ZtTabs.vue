...
const activeTab=computed(()=>{
  if(panes.some(item=>item.props.name===props.modelValue&&!item.props.disabled))return props.modelValue
  // Ensure a keyboard entry point when modelValue matches no pane.
  return panes.find(item=>!item.props.disabled)?.props.name
})
