...
export type ZtPopoverPlacement='top'|'top-start'|'top-end'|'bottom'|'bottom-start'|'bottom-end'|'left'|'left-start'|'left-end'|'right'|'right-start'|'right-end'
...
export interface ZtPopoverInstance{show:()=>void;hide:()=>void;toggle:()=>void;updatePosition:()=>void}
